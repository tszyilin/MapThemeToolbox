...
class CreateThemesDialog(QDialog):
    ...
    def _build_manual_tab(self):
        ...
        self.manual_list.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
    ...
    def _build_csv_tab(self):
        ...
        self.csv_list.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
